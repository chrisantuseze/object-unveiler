...
class Policy:
    ...
    def get_unveiler_inputs(self, color_image, target_mask, processed_masks, bbox):
        ...
        return processed_scene_image, processed_target, processed_obj_masks, bboxes, bbox, objects_to_remove
    ...
    def exploit_decoder_only(self, state, color_image, target_mask):
