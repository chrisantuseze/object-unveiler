...
def get_distances_to_edge1(masks, workspace_size=100):
    print("Method 2")
    for i, mask in enumerate(masks):
        print(i, "-", distance_to_edge(mask, workspace_size))


def get_distances_to_edge2(segmentation_masks, workspace_size=(100, 100)):
    distances = []
    print("Method 2")
...
def get_distances_to_edge3(segmentation_masks, workspace_size=(100, 100)):
    distances_list = []
