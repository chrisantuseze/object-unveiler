...
def parse_args():
    ...
    parser.add_argument('--num_patches', default=9, type=int, help='This should not be less than the maximum possible number of objects in the scene, which from list Environment.nr_objects is 9')
