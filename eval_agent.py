...
def run_episode_old0_(policy: Policy, env: Environment, segmenter: ObjectSegmenter, rng, episode_seed, success_count, max_steps=15, train=True):
    env.seed(episode_seed)
    obs = env.reset()
...
# single output with ViT for evaluating obstacle then target grasping 
