...
class TagGraspNode:
    def __init__(self):
        ...
        self.down_joint = [50.0, 90.0, 34.0, 16.0, 90.0,140]
    ...
    def move(self):
        ...
        #time.sleep(2.5)
        '''if self.cur_tagId == 1:
            self.down_joint = [130.0, 55.0, 34.0, 16.0, 90.0,140]
        elif self.cur_tagId == 2:
            self.down_joint = [170.0, 55.0, 34.0, 16.0, 90.0,140]
        elif self.cur_tagId == 3:
            self.down_joint = [50.0, 55.0, 34.0, 16.0, 90.0,140]
        elif self.cur_tagId == 4:
            self.down_joint = [10.0, 55.0, 34.0, 16.0, 90.0,140]'''
