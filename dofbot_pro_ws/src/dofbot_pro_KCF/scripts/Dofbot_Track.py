...
class DofbotTrack:
    def __init__(self):
        ...
        self.joint6_sub = rospy.Subscriber("joint6",Float32,self.get_joint6Callback)
        self.sub_depth = rospy.Subscriber("/camera/depth/image_raw",Image,self.GetDepthInfo)
    ...
    def GetDepthInfo(self,depth_frame):
        ...
        if self.lx!=0.0 and self.rx!=0:
            ...
            if self.stop_flag == True:
                ...
                self.set_joint6 = 180 - res_width*100*17
                print("self.set_joint6: ",self.set_joint6)
    ...
    def Clamping(self,cx,cy,cz):
        ...
        try:
            ...
            joints[4] = 90 
            joints[5] = 20
            if request.tar_y>0.18 and request.tar_y<0.26:
                self.Buzzer()
                grab_status = Bool()
    ...
    def move(self):
        print("self.set_joint6: ",self.set_joint6)
        #time.sleep(2.5)
        self.pub_arm([],6, self.set_joint6, 1000)
        time.sleep(2.5)
