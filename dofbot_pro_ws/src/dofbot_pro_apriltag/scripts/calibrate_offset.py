...
offset_config['x_offset'] = int(offset_config['x_offset'])
offset_config['y_offset'] = int(offset_config['y_offset'])
offset_config['z_offset'] = int(offset_config['z_offset'])
print(offset_config)
print("----------------------------")
class TagGraspNode:
    def __init__(self):
        ...
        self.tag_info_sub = rospy.Subscriber("PosInfo", AprilTagInfo, self.tag_info_callback, queue_size=1)
        ...
        '''self.EndToCamMat = np.array([[ 1.00000000e+00, -8.14579291e-17, -3.43013174e-17, -1.10259362e-02],
                                     [ 7.65772276e-18, -5.01378661e-01,  8.65227969e-01,  1.26116134e-01],
                                     [ 4.57376377e-17, -8.65227969e-01, -5.01378661e-01, -1.97760399e-02],
                                     [ 8.35235551e-17,  3.42321035e-16,  8.94539357e-17,  1.00000000e+00]])'''
    ...
    def tag_info_callback(self,msg):
        ...
        if pos_z!=0.0:
            ...
            pose_T[1] = pose_T[1] + self.y_offset#0.012为标定后的数据，可调
            pose_T[2] = pose_T[2] + self.z_offset #0.0011为标定后的数据，可调
            print("pose_T: ",pose_T)
            print("pose_R: ",pose_R)'''
    ...
    def grasp(self,pose_T):
        ...
        print("orin_dist: ",0.181-math.sqrt(request.tar_y**2+request.tar_x**2))
...
if __name__ == '__main__':
    try:
        ...
        #tag_grasp.pubArm([90.0, 120, 0.0, 0.0, 90, 90])
