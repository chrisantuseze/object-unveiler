...
class ColorDetect:
    def __init__(self):
        ...
        # 订阅相机图像话题
        #source_image_topic = rospy.get_param('~source_image_topic', '/camera/depth/image_raw')
        ...
        #self.depth_image_sub = rospy.Subscriber(source_image_topic, Image, self.depth_image_callback, queue_size=1)
