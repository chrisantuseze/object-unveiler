...
class ColorGraspNode:
    def __init__(self):
        ...
        self.Color_Pos_sub = rospy.Subscriber('xyz', Position, self.color_pos_callback, queue_size=10)
        ...
        self.down_joint = [140.0, 55.0, 34.0, 16.0, 90.0,125]
    ...
    def color_pos_callback(self,msg):
        ...
        if color_z!=0.0:
            ...
            heigh = Float32()
            heigh.data = pose_T[2]
            self.pub_heigh.publish(heigh)
            print("height: ",pose_T[2])
            #print("pose_T: ",pose_T)
            if self.grasp_flag == True and pose_T[2]>0.03:
